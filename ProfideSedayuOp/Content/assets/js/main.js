      ...
      searchInput.each(function () {
        ...
        searchInput
          .typeahead(
            ...
            // Pages
            {
              ...
              templates: {
                ...
                suggestion: function ({ url,con, icon, name }) {
                  return (
                    '<a href="' +
                    url +
                    '">' +
          ...
          .bind('typeahead:select', function (ev, suggestion) {
            // Open selected page
            if (suggestion.url) {
                var url = '@Url.Action("ActionName", "ControllerName")'; // Gantilah dengan Action dan Controller yang sesuai

                // Gantilah placeholder dengan nilai dari suggestion
                url = url.replace('ActionName', suggestion.url).replace('ControllerName', suggestion.con);

                // Arahkan ke URL yang dihasilkan
