...
namespace ProfideSedayuOp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> GetDataPengecekan(ParamGetPengajuan dt)
        {
            try
            {
                var xx = Session["DataLog"];
        ...
        public async Task<ActionResult> AddTableDataToExcel(string Startdate, string EndDate, string jenisCek)
        {
            var xx = Session["DataLog"];
            var log = Session["Name"];
            if (xx == null || xx.ToString() == "")
